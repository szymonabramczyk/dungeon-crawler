...
const std::string& Entity::GetType() const { return type_; }
int Entity::GetHitPoints() const { return health_points_; }
const sf::Vector2f Entity::GetPosition() const { return sprite_.getPosition(); }
const int Entity::MaxHP() const { return max_hp_; }
bool Entity::IsMonster() const { return is_monster_; }
bool Entity::IsDead() const { return is_dead_; }
bool Entity::IsBoss() const { return is_boss_; }
...
void Entity::DrawHitpoints(sf::RenderTarget& target) {
